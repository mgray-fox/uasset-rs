...
const LATEST_UE5_MINOR_VERSION: u32 = 6;
...
#[case::ue_5_6(test_utilities::UnrealVersionInfo::ue5(
    6,
    test_utilities::ObjectVersionUE5::OS_SUB_OBJECT_SHADOW_SERIALIZATION
))]
